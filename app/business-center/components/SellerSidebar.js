...
export default function SellerSidebar() {
  ...
  return (
    <aside className="seller-sidebar">
      ...
      {/* Holiday Mode Toggle */}
      <div className="seller-holiday-toggle" style={{ background: holidayMode ? '#FEF2F2' : '#F8FAFC', border: holidayMode ? '1px solid #FCA5A5' : '1px solid #E2E8F0', padding: '10px 14px', borderRadius: '12px' }}>
        <div>
          <span style={{ fontWeight: 700, fontSize: '0.85rem', color: holidayMode ? '#DC2626' : '#1E293B' }}>Holiday Mode</span>
          {holidayMode && <small style={{ display: 'block', color: '#EF4444', fontSize: '0.7rem', fontWeight: 600 }}>Store Paused</small>}
        </div>
        <div
